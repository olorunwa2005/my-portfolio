            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid md:grid-cols-3 gap-12 mb-16">
                    <div className="space-y-6">
                        <h3 className="text-2xl font-bold text-diamond tracking-tighter">JUSTICE.</h3>
                    ...
                    <div className="space-y-6">
                        <h4 className="font-bold text-sm uppercase tracking-widest text-slate-200">Contact</h4>
                        <ul className="space-y-3">
                            <li className="flex items-center gap-3 text-slate-400 hover:text-diamond transition-colors cursor-pointer group">
                                <Mail size={18} className="text-diamond group-hover:scale-110 transition-transform" />
                                {CONTACT_DATA.email}
                            </li>
                    ...
                    <div className="space-y-6">
                        <h4 className="font-bold text-sm uppercase tracking-widest text-slate-200">Follow Me</h4>
                ...
                <div className="h-px w-full bg-gradient-to-r from-transparent via-diamond/30 to-transparent mb-12"></div>
