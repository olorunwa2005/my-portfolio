            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                >
                    <div className="space-y-4">
                        <h2 className="text-3xl md:text-5xl font-bold mb-6 md:mb-8 flex items-center gap-4">
                    ...
                    <div className="pt-4 md:pt-8 grid grid-cols-2 gap-4 md:gap-6">
                        {ABOUT_DATA.stats.map((stat, index) => (
                            <motion.div
                                ...
                                className="p-4 md:p-6 rounded-[24px] glass dark:glass-dark border border-diamond/10 hover:border-diamond/30 transition-all duration-500"
                            >
                                <h4 className="text-diamond font-black text-3xl md:text-4xl mb-1">{stat.value}</h4>
